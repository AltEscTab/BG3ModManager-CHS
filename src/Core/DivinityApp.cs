...
public static class DivinityApp
{
	...
	public const string URL_CHS_REPO = @"https://github.com/AltEscTab/BG3ModManager-CHS";
	public const string URL_CHS_RELEASES = @"https://github.com/AltEscTab/BG3ModManager-CHS/releases";
